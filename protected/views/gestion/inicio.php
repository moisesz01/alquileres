...
<div class="">
       <!-- Remuneracion -->
    <a href="<?php echo Yii::app()->createUrl('gestion/buscarcliente'); ?>">
  
        <img width="120px" height="120px" src="<?php echo Yii:: app()->baseUrl.'/images/gestioncobros.png' ?> " />
        <button type="button" class="btn btn-warning">INICIAR GESTION <br/>DE ALQUILERES</button>
...
//'options' => array('unit'=>array('selected'=>true))
       ...
       /* array(
        ...
        (
            ...
            'url'=>'Yii::app()->createUrl("gestion/buscarcliente", array("id"=>$data->id_cliente))',
        ),
     ),
        ),
),
